  ...
  return (
    <footer className="bg-black text-white py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h2 className="text-xl font-semibold mb-4">Delish Bites</h2>
          <p className="text-gray-400">
            Fine dining experience in the heart of the city. Book your table and
            indulge in our seasonal menus.
          </p>
        </div>
